...
load(paste0(paste0("Z:/Inshore/Assessment/BoF/",year,"/Assessment/Data/Growth/SPA1A1B4and5/BFgrowth",year,".RData")))
...
source(paste0("Z:/Inshore/Assessment/BoF/",year,"/Assessment/Data/Growth/SPA1A1B4and5/SPA1B",year,".SHobj.R"))
...
spa1b.growthrate <- read.csv(paste0("Z:/Inshore/Assessment/BoF/",year-1,"/Assessment/Data/Growth/SPA1A1B4and5/spa1b.growthrate.",year-1,".csv"))
