...
source(paste0("Z:/Inshore/Assessment/BoF/",year,"/Assessment/Data/Growth/SPA1A1B4and5/SPA1A",year,".SHobj.R"))
...
spa1a.growthrate <- read.csv(paste0("Z:/Inshore/Assessment/BoF/",year-1,"/Assessment/Data/Growth/SPA1A1B4and5/spa1a.growthrate.",year-1,".csv"))
