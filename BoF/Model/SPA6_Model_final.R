...
stats.output <- BoF.model.stats(area = "6", assessmentyear=assessmentyear, surveyyear=surveyyear, direct = "Z:/Inshore/Assessment/BoF/", RDatafile = paste0("SPA6_Model_",surveyyear))
